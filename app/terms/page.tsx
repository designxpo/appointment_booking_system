...
export const metadata: Metadata = {
  ...
  description: "The terms that govern your use of FlowBookAI.",
};
...
const SECTIONS: LegalSection[] = [
  {
    ...
    body: [
      "By creating an account or using FlowBookAI, you agree to these terms. If you're using the service on behalf of a business, you confirm you're authorized to bind that business to these terms.",
    ],
  },
  {
  ...
  },
  {
    ...
    bullets: [
      "Use FlowBookAI for unlawful, deceptive, or harmful purposes.",
  ...
  },
  {
    ...
    body: [
      "We work hard to keep FlowBookAI available but don't guarantee uninterrupted service. We may update features, these terms, or our plans; material changes will be communicated, and continued use means you accept the updated terms.",
    ],
  },
  {
    heading: "Disclaimer & liability",
    body: [
      "The service is provided \"as is\" without warranties of any kind. To the maximum extent permitted by law, FlowBookAI is not liable for indirect or consequential damages, and our total liability is limited to the amount you paid in the prior three months.",
    ],
  },
  {
    heading: "Contact",
...
export default function TermsPage() {
  return (
    <LegalPage
      title="Terms of Service"
      intro="The ground rules for using FlowBookAI, written to be readable rather than impenetrable."
